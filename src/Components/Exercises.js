...
const Exercises = ({ exercises, setExercises, bodyPart }) => {
  ...
  const currentExercises = React.useMemo(
    () => (Array.isArray(exercises) ? exercises.slice(indexOfFirstExercise, indexOfLastExercises) : []),
    [exercises, currentPage, indexOfFirstExercise, indexOfLastExercises]
  );
